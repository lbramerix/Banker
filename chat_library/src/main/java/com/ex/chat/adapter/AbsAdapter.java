package com.ex.chat.adapter;

import android.os.Handler;
import android.os.Message;

import com.ex.chat.animator.ChartAnimator;
import com.ex.chat.compat.DataSetObservable;
import com.ex.chat.compat.Utils;
import com.ex.chat.entry.AbsEntry;
import com.ex.chat.enumeration.ObserverArg;
import com.ex.chat.thread.WorkThread;
...
public abstract class AbsAdapter<T extends AbsEntry>
    ...
    @Override
    public void onWork(List<T> data, ObserverArg observerArg) {
        buildData(data);
